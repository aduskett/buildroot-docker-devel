################################################################################
#
# open-plc-utils-updated
#
################################################################################

OPEN_PLC_UTILS_UPDATED_VERSION = 32408520fcebe785983a68e39ec83830a3005779
OPEN_PLC_UTILS_UPDATED_SITE = $(call github,qca,open-plc-utils,$(OPEN_PLC_UTILS_UPDATED_VERSION))
OPEN_PLC_UTILS_UPDATED_LICENSE = BSD-3-Clause
OPEN_PLC_UTILS_UPDATED_LICENSE_FILES = LICENSE
...
OPEN_PLC_UTILS_UPDATED_MAKE_OPTS = \
	EXTRA_CFLAGS="$(TARGET_CFLAGS) -D__UCLIBC__" \
	EXTRA_CXXFLAGS="$(TARGET_CXXFLAGS)" \
	EXTRA_LDFLAGS="$(TARGET_LDFLAGS)"

define OPEN_PLC_UTILS_UPDATED_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(MAKE) CROSS=$(TARGET_CROSS) \
		$(OPEN_PLC_UTILS_UPDATED_MAKE_OPTS) -C $(@D)
endef

define OPEN_PLC_UTILS_UPDATED_INSTALL_TARGET_CMDS
